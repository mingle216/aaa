  ...
  <div class="nav__menus">
    <template v-for="navMenu in navMenus">
      ...
      >
        <div class="menu_item_box" @click="handleClickMenu(navMenu)">
          ...
          <span
            ...
            :title="isShowTitle($t(navMenu.menuNameLangKey), navMenu.level > 0 || menuIndex === 'more' ? 14 : 8) ? $t(navMenu.menuNameLangKey) : ''"
          >
      ...
      <el-submenu
        ...
        :class="navMenu.level === 0 && menuIndex !== 'more' ? 'menu__mr' : ''"
      >
        <p
...
export default {
  ...
  computed: {
    ...
    openedMenus() {
      return this.dom && this.dom.openedMenus && this.dom.openedMenus.length || 0
    }
  },
  watch: {
    openedMenus(val) {
  ...
  methods: {
    ...
    handleClickMenu(item) {
      ...
      this.handleClickTrack(item) // 点击埋点
      ...
      window.minosStataCollect.collect({
        ...
        actionParams: {
          ...
          extraInfo: {
            ...
            filterInfo: {
              menuWid: navMenu.wid,
              menuName:  this.$t(navMenu.menuNameLangKey)
            }
          }
        },
      });

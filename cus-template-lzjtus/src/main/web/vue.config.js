...
module.exports = {
  publicPath: process.env.NODE_ENV === 'development' ? 'http://localhost:8003/' : './',
  outputDir: '../resources/static/CUS_TEMPLATE_LZJTUS/pc',
  configureWebpack:{
    devtool: false,
    externals: {
      vue: 'Vue',
    ...
    plugins: [
      ...
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: process.env.NODE_ENV === 'development' ?  '' : '/CUS_TEMPLATE_LZJTUS/pc',

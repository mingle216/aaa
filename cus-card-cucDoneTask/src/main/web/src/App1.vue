  ...
  <div class="task-con" ref="taskCon">
    <AutoContainer :con-type="0">
      <div class="donetask">
        ...
        <div class="right" ref="rt2" v-show="datacount">
          <AutoContainer
            :con-type="type"
            :con-height="height"
            :scroll="rightScroll"
                ...
                >
                  ...
                  >
                    <div class="title-con">
                      ...
                      <div
                        class="state-con"
                        v-if="itemConfigure.includes('state')"
                      >
                        <div
                          class="state-tag st1"
                    ...
                    <div
                      class="lct portal-primary-color-lv1"
                      :class="{ 'hide-text': !defaultModel }"
                      v-if="showFlowChart(item)"
                      @click="move2(item)"
                    >
                      <i class="iconfont icon-flowChart"></i>
                      <span class="lctword">流程图</span>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      ...
                      <we-tooltip
                        v-if="
                          itemConfigure.includes('scene') && taskSource === 2
                        "
                        class="show-item text-ellipsis"
                        effect="dark"
                        placement="bottom-start"
...
export default {
  ...
  methods: {
    ...
    move2(val) {
      // 流程图跳转
      // console.log(val.processInstanceImageUrl);
    ...
    getList(item) {
      // this.lctVisible()  // !!!
      // this.subList = item.sublist; // test

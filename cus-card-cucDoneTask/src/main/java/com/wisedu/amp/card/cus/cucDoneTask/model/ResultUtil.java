...
public class ResultUtil {
    ...
    public static final String QUERY_DONE_TASK = "queryDoneTask";
    ...
    /***
     * 返回给移动端任务中心待办地址url的key
     * @author jszhang
     */
//    public static String DONE_TASK_URL="doneTaskUrl";
...
//        SOURCE_LIST_URL("任务分类列表接口地址", "/taskCenter/task/getTaskCountByBusinessSource.do"),
//        TODO_TASK_LIST_URL("待办任务列表接口地址", "/taskCenter/task/getTaskRestful.do"),
//        TODO_TASK_COUNT_URL("待办任务数量接口地址", "/taskCenter/task/getTaskTodoAndDoneCount.do");

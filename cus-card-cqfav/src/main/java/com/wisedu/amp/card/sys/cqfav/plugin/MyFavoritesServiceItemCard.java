package com.wisedu.amp.card.sys.cqfav.plugin;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.common.base.Splitter;
import com.wisedu.amp.card.sys.cqfav.model.AmpBaseResponse;
import com.wisedu.amp.card.sys.cqfav.model.CollectServiceItemsRequest;
import com.wisedu.amp.card.sys.cqfav.model.Config;
import com.wisedu.amp.card.sys.cqfav.model.ConfigH5;
import com.wisedu.amp.card.sys.cqfav.model.ConfigInfo;
import com.wisedu.amp.card.sys.cqfav.model.ContainerType;
import com.wisedu.amp.card.sys.cqfav.model.FavoriteServiceItemRequest;
import com.wisedu.amp.card.sys.cqfav.model.MyFavouritesServiceitemResponse;
import com.wisedu.amp.card.sys.cqfav.model.ResultUtil;
import com.wisedu.amp.card.sys.cqfav.model.UserFavoriteServiceItems;
import com.wisedu.amp.card.sys.cqfav.model.UserFavoriteServiceItemsRequest;
import com.wisedu.amp.card.sys.cqfav.util.MyRestTemplateUtil;
...
public class MyFavoritesServiceItemCard extends AbstractCard {
    ...
    private ResultData favoriteServiceItem(CardAjaxRequest request) {
        try {
            ...
            ResultData<String> result = MyRestTemplateUtil.httpRequestForObject(entity, "/coosk/itemManager/favoriteItem", HttpMethod.POST, ResultData.class, String.class);
    ...
    private String view(CardAjaxRequest request) {
        try {
            ...
            if (null == user || StringUtil.isEmpty(user.getWid())) {
                ...
                userFavoriteServiceItemsRequest.setUserAccount(user.getUserAccount());
                ...
                try {
                    ...
                    response = RestTemplateUtils.post("/coosk/userItemFavoriteList", entity, MyFavouritesServiceitemResponse.class).getBody();
    ...
    public Object sort(CardAjaxRequest request){
        ...
        // 获取收藏或取消收藏应用接口地址
        try {
            response = RestTemplateUtils.post("/coosk/itemManager/batchFavoriteItem", entity, AmpBaseResponse.class).getBody();
        } catch ( Exception e ) {

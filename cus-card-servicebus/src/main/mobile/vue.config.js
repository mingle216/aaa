 ...
 * @Date: 2023-07-26 11:16:42
 * @LastEditors: 杨芯悦 xyyang01@wisedu.com
 * @LastEditTime: 2023-07-26 11:21:34
 */
...
module.exports = {
  publicPath: devMode ? 'http://localhost:6003' : '/CUS_CARD_SERVICEBUS/mobile',
  outputDir: '../resources/static/CUS_CARD_SERVICEBUS/mobile',
  configureWebpack:{
    devtool: false,
    watch: false,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/CUS_CARD_SERVICEBUS/mobile/',

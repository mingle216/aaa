    ...
    <div class="search">
      ...
      <div class="content__wrapper">
        <we-container class="hall">
          <main-container cardArea="default" :pageData="pageData">
...
export default {
  ...
  computed: {
    // pageData(){
    //     console.log(8888,  JSON.parse(JSON.stringify(window.shell.getPageData())))
    //     return JSON.parse(JSON.stringify(window.shell.getPageData()))

<template>
  <div>
    <we-dialog
      ...
      :append-to-body="true"
      class="card__personalData__BindEmailModal"
    ...
    >
              ...
              <div ref="emailSuffix" class="card__personalData__email__suffix">
                <div v-if="emailSuffixList.length > 1">
                  ...
                  <div
                    ...
                    class="card__personalData__email__drop"
                  >
                    <div
      ...
      <span slot="footer" class="dialog-footer">
        <we-button
          ...
          >{{ $Lan(lanFunName, "textCancel", "取 消") }}</we-button
        >
        <we-button
          ...
          type="primary"
          @click="handlerSubmit"
          >{{ $Lan(lanFunName, "textEnsure", "确 定") }}</we-button
        >
      </span>
    </we-dialog>
  </div>
...
export default {
  ...
  mounted() {
    console.log('DZcardID1111',this.DZcardID,this. DZcardName)
...
.card__personalData__BindEmailModal {
  overflow: hidden;
  display: flex;

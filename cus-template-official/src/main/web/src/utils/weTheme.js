...
export default {
  ...
  ".we-input__inner::-moz-placeholder,.we-textarea__inner::-moz-placeholder": "{color: @portal-font-color-lv4}", //火狐输入框placeholder文字颜色
  ".we-input__inner:-ms-input-placeholder,.we-textarea__inner:-ms-input-placeholder": "{color: @portal-font-color-lv4}", //IE输入框placeholder文字颜色
  ...
  ".we-radio__input.is-checked .we-radio__inner": "{background-color: @portal-primary-color-lv1 !important;border-color: @portal-primary-color-lv1 !important;}",
  ".we-radio__inner:hover": "{border-color: @portal-primary-color-lv1 !important;}",
  ".we-button--text, .we-button--text:focus, .we-button--text:hover": "{color: @portal-primary-color-lv1}",
  ".we-time-panel__btn.confirm, .we-month-table td.today .cell, .we-month-table td.current:not(.disabled) .cell,.we-year-table td .cell:hover,.we-year-table td.today .cell, .we-year-table td.current:not(.disabled) .cell": "{color: @portal-primary-color-lv1}",
  ".we-date-picker__header-label.active, .we-date-picker__header-label:hover,.we-picker-panel__icon-btn:hover, .we-month-table td .cell:hover": "{color: @portal-primary-color-lv1}",
  ".we-date-table td.current:not(.disabled) span": "{background-color: @portal-primary-color-lv1}",
  ".we-form-item__label":"{color: @portal-font-color-lv1}",
  ".dz-servicebus .service-bus-source-item-active::before ": "{  background: @portal-primary-color-lv1}",
  ".dz-todo-task .source-list .active::before": "{background: @portal-primary-color-lv1}",
  ".dz-done-task .source-list .active::before": "{background: @portal-primary-color-lv1}"
};

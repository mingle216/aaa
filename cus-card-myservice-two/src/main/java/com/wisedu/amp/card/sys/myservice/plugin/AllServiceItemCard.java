package com.wisedu.amp.card.sys.myservice.plugin;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.wisedu.amp.card.sys.myservice.enums.DisplayTypeEnum;
import com.wisedu.amp.card.sys.myservice.enums.ItemDisplayInfoEnum;
import com.wisedu.amp.card.sys.myservice.model.*;
import com.wisedu.amp.card.sys.myservice.util.AllServiceItemUtil;
import com.wisedu.amp.card.sys.myservice.util.ChinesePinyinUtil;
...
public class AllServiceItemCard extends AbstractCard {
    ...
    public String getCardId() {
        return "CUS_CARD_MYSERVICE_TWO";
    }

    @Override
    public void destroy() {
        logger.debug("card[CUS_CARD_MYSERVICE_TWO] destroyed ...");
    }
     ...
     * @param
     * @throws
     * @return java.util.List<com.wisedu.amp.card.sys.myservice.enums.ItemDisplayInfoEnum>

...
module.exports = {
  publicPath: devMode ? 'http://localhost:5111' : '/CUS_CARD_MYSERVICE_TWO/mobile',
  outputDir: '../resources/static/CUS_CARD_MYSERVICE_TWO/mobile',
  configureWebpack:{
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/CUS_CARD_MYSERVICE_TWO/mobile/',

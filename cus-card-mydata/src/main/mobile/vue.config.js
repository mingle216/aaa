...
module.exports = {
  publicPath: devMode ? 'http://localhost:5555' : '/SYS_CARD_PERSONALDATA/mobile',
  outputDir: '../resources/static/SYS_CARD_PERSONALDATA/mobile',
  configureWebpack:{
    devtool: false,
    watch: false,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/SYS_CARD_PERSONALDATA/mobile/',

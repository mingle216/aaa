<template>
  <div class="optBtnWrap">
    ...
    >
      <we-tooltip
        effect="dark"
        :content="$Lan('CUS_CARD_GXCAL', 'syncDingTalk', '同步钉钉数据')"
        placement="top"
        :open-delay="500"
      >
    ...
    >
      <we-tooltip
        effect="dark"
        :content="$Lan('CUS_CARD_GXCAL', 'backToday', '回到今天')"
        placement="top"
        :open-delay="500"
      >
        <span
    ...
    >
      ...
      >
        <we-tooltip
          effect="dark"
          :content="$Lan('CUS_CARD_GXCAL', 'subscribe', '订阅')"
          placement="top"
          :open-delay="500"
        >
          <span
    ...
    >
      ...
      >
        <we-tooltip
          effect="dark"
          :content="$Lan('CUS_CARD_GXCAL', 'externalReference', '外部引用')"
          placement="top"
          :open-delay="500"
        >
          <span
    ...
    >
      <we-tooltip
        effect="dark"
        :content="$Lan('CUS_CARD_GXCAL', 'showMore', '查看更多')"
        placement="top"
        :open-delay="500"
      >

...
.cardCalendar__listsRow {
  ...
  &:nth-of-type(3n + 1){
    background: #F3F7FF;
    border: 1px solid rgba(48, 122, 251, 0.3);
    .timeRange{
      background: url(../assets/images/cbg1.png);
  ...
  &:nth-of-type(3n + 2){
    ...
    .timeRange{
      background: url(../assets/images/cbg2.png);
      background-size: 100% 100%;
    }
  }
  &:nth-of-type(3n){
    background: rgba(23, 191, 106, 0.05);
    border: 1px solid rgba(23, 191, 106, 0.3);
    .timeRange{

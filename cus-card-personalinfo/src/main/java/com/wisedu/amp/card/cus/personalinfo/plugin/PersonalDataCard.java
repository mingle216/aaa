package com.wisedu.amp.card.cus.personalinfo.plugin;
...
import com.wisedu.amp.card.cus.personalinfo.model.CheckBox;
import com.wisedu.amp.card.cus.personalinfo.model.ConfigModel;
import com.wisedu.amp.card.cus.personalinfo.model.PersonalDataInfo;
import com.wisedu.amp.card.cus.personalinfo.model.PersonalDataResponse;
import com.wisedu.amp.card.cus.personalinfo.service.*;
        ...
        if(null!=currentUser){
            ...
            if (CollectionUtils.isNotEmpty(userLoginEntityList)) {
                ...
                if(userLoginEntities.size() > 1){
                    userLoginEntity=userLoginEntities.get(1);
                }
                if(null!=userLoginEntity){
                    logTime = DateUtil.getStrFromDate(userLoginEntity.getCreateTime(), DateUtil.DATE_FORMATE_STRING_A);
                    logIp = userLoginEntity.getLoginIp();

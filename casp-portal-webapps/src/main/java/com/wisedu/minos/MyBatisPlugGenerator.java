...
public class MyBatisPlugGenerator {
    ...
    // 开启二级缓存的表，慎重修改
    private static final String[] cachedTables = new String[]{"T_AMP_ATTACH_ENTITY_REL", "T_AMP_ATTACH_INFO", "T_AMP_VIEW_CARD",
            "T_AMP_VIEW_INTERNATIONAL", "T_AMP_VIEW_MENU_AUTH", "T_AMP_VIEW_MENU", "T_AMP_VIEW_OLD_OSS",
            "T_AMP_VIEW_PAGE_CARD_CONFIG", "T_AMP_VIEW_PAGE_INFO", "T_AMP_PERSONAL_DATA_AUTH",
            "T_AMP_PERSONAL_DATA", "T_AMP_VIEW_POPUP_WINDOW", "T_AMP_VIEW_PRO_LOCAL_STYLE",
            "T_AMP_VIEW_SHOW_PROGRAMME", "T_AMP_VIEW_SIDEBAR", "T_AMP_VIEW_SITE_AUTH",
            "T_AMP_VIEW_SITE_MAG", "T_AMP_VIEW_SITE", "T_AMP_SYS_ICON", "T_AMP_VIEW_SYSTEM_CONFIG",
            "T_AMP_VIEW_TEMPLATE", "T_AMP_VIEW_VERSION_MANAGEMENT", "T_AMP_USER_EMAIL", "T_AMP_VIEW_SELECT_MENU"};

    // 需要生成的表
    private static final String table = "T_AMP_VIEW_SELECT_MENU";
    // 需要忽略的表前缀
    ...
    public static void main(String[] args) {
        ...
        boolean enableCache = Arrays.asList(cachedTables).contains(table);

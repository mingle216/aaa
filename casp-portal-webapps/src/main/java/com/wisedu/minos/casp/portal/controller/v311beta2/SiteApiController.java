...
public class SiteApiController implements SiteApi {
    ...
    * 查询单个站点信息
    **/
    @ManagerGatewayApi(name = "查询单个站点信息",realPath = "/site/changeEnableStatus")
    ...
    * 删除站点
    **/
    @ManagerGatewayApi(name = "删除站点",realPath = "/site/deleteSite")
    ...
    * 保存站点
    **/
    @ManagerGatewayApi(name = "保存站点",realPath = "/site/saveSite")
    ...
    * 站点排序
    **/
    @ManagerGatewayApi(name = "站点排序",realPath = "/site/sortSites")

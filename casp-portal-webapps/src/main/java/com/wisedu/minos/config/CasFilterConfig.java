...
public class CasFilterConfig {
    ...
    public ServletListenerRegistrationBean servletListenerRegistrationBean() {
        ...
        LOGGER.info("init servletListenerRegistrationBean");
    ...
    public FilterRegistrationBean singleSignOutFilter() {
        ...
        LOGGER.info("init singleSignOutFilter");
    ...
    public FilterRegistrationBean cas30ProxyReceivingTicketValidationFilter() {
        ...
        LOGGER.info("init cas30ProxyReceivingTicketValidationFilter");
        return registrationBean;
    }
    ...
    public FilterRegistrationBean httpServletRequestWrapperFilter() {
        ...
        LOGGER.info("init httpServletRequestWrapperFilter");
        return registrationBean;
    }
    ...
    public FilterRegistrationBean idsLoginFilter() {
        ...
        registrationBean.setEnabled(true);
        registrationBean.setFilter(new IDSLoginFilter(casProperties,redisExpireTime));
        ...
        LOGGER.info("init idsLoginFilter");
        return registrationBean;
    }

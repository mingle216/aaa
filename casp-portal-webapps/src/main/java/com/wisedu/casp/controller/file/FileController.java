...
import com.wisedu.minos.casp.portal.common.utils.PropertiesUtil;
...
public class FileController {
     ...
     **/
    @ManagerGatewayApi(name = "卡片、模板确认/取消覆盖方法、确认/取消安装最新新卡片、模板", realPath = "/fileTodo/confirmCoverage")

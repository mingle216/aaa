...
public class ProgrammeApiController implements ProgrammeApi {
    ...
    * 复制展示方案
    **/
    @ManagerGatewayApi(name = "复制展示方案",realPath = "/programme/copyProgramme",operationType = ApiOperationTypeEnums.API_OPERATION_ADD)
    ...
    * 展示方案--删除菜单
    **/
    @ManagerGatewayApi(name = "展示方案--删除菜单",realPath = "/programme/deleteMenu",operationType = ApiOperationTypeEnums.API_OPERATION_DELETE)
    ...
    * 展示方案--删除页面
    **/
    @ManagerGatewayApi(name = "展示方案--删除页面",realPath = "/programme/deletePageInfo",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 删除展示方案,支持批量删除应用
    **/
    @ManagerGatewayApi(name = "删除展示方案,支持批量删除应用",realPath = "/programme/deleteProgramme",operationType = ApiOperationTypeEnums.API_OPERATION_DELETE)
    ...
    * 根据主键删除侧边栏
    **/
    @ManagerGatewayApi(name = "根据主键删除侧边栏",realPath = "/programme/deleteSidebar",operationType = ApiOperationTypeEnums.API_OPERATION_DELETE)
    ...
    * 展示方案-复制页面信息
    **/
    @ManagerGatewayApi(name = "展示方案-复制页面信息",realPath = "/programme/saveCopyOfPageInfo",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 新增修改菜单信息
    **/
    @ManagerGatewayApi(name = "新增修改菜单信息",realPath = "/programme/saveMenuInfo",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 新增修改页面信息
    **/
    @ManagerGatewayApi(name = "新增修改页面信息",realPath = "/programme/savePageInfo",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 新增修改展示方案信息
    **/
    @ManagerGatewayApi(name = "新增修改展示方案信息",realPath = "/programme/saveProgrammeInfo",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 新增修改侧边栏信息
    **/
    @ManagerGatewayApi(name = "新增修改侧边栏信息",realPath = "/programme/saveSidebarInfo",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 修改菜单排序
    **/
    @ManagerGatewayApi(name = "修改菜单排序",realPath = "/programme/updateMenuSequence",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 展示方案菜单启用禁用
    **/
    @ManagerGatewayApi(name = "展示方案菜单启用禁用",realPath = "/programme/updateMenuStatus",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 停用启用页面信息
    **/
    @ManagerGatewayApi(name = "停用启用页面信息",realPath = "/programme/updatePageStatusByWid",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 侧边栏排序
    **/
    @ManagerGatewayApi(name = "侧边栏排序",realPath = "/programme/updateSidebarSequence",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 侧边栏启用禁用
    **/
    @ManagerGatewayApi(name = "侧边栏启用禁用",realPath = "/programme/updateSidebarStatus",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    * 停用启用展示方案
    **/
    @ManagerGatewayApi(name = "停用启用展示方案",realPath = "/programme/updateStatusByWid",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)
    ...
    @ManagerGatewayApi(name = "保存系统弹窗",realPath = "/programme/savePopupWindow",operationType = ApiOperationTypeEnums.API_OPERATION_MODIFY)

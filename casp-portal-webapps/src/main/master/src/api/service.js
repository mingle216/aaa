...
// 查询是否开启服务url检测开关
export const getServiceAccessEnable = async (params, config) => {
  return awaitWrap(http.get(`${api['getServiceAccessEnable']}`, params, config))
}
// 查询服务url是否可访问
export const getServiceAccessCheck = async (params, config) => {
  return awaitWrap(http.post(`${api['getServiceAccessCheck']}`, params, config))
}
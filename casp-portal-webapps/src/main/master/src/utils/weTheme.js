...
export const themeMapPc = {
  ...
  ".we-checkbox__input.is-disabled+span.we-checkbox__label": "{color: @portal-font-color-lv4}",
  ".todoTree.we-tree--highlight-current .we-tree-node.is-current>.we-tree-node__content .we-tree-node__expand-icon:not(.is-leaf)": "{color:@portal-primary-color-lv1}"
};
// h5模板的组件样式
export const themeMapH5 = {
  ...
  ".search_primary_border .we-search__content": "{border-color:@portal-primary-color-lv1 !important}"
};

...
module.exports = {
  publicPath: process.env.NODE_ENV === 'development' ? 'http://localhost:6107/' : '/CUS_CARD_RECOMMENDSERVICEITEMS/pc',
  outputDir: '../resources/static/CUS_CARD_RECOMMENDSERVICEITEMS/pc',
  configureWebpack:{

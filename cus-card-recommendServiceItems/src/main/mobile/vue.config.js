...
module.exports = {
  publicPath: devMode ? 'http://localhost:5010' : '/CUS_CARD_RECOMMENDSERVICEITEMS/mobile',
  outputDir: '../resources/static/CUS_CARD_RECOMMENDSERVICEITEMS/mobile',
  configureWebpack:{
    devtool: false,
    watch: false,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/CUS_CARD_RECOMMENDSERVICEITEMS/mobile/',

...
module.exports = {
  publicPath: process.env.NODE_ENV === 'development' ? 'http://localhost:8006/' : './',
  outputDir: '../resources/static/CUS_TEMPLATE_CQUPT/mobile',
  configureWebpack: {
    devtool: false,
    externals: {
      vue: 'Vue',
    ...
    plugins: [
        new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
          filename: '[file].map',
          publicPath: process.env.NODE_ENV === 'development' ? '' : '/CUS_TEMPLATE_CQUPT/mobile',

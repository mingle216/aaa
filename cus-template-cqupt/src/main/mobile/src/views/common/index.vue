 <template>
  <div class="container">
    <div class="common-head" :style="headerStyle">
      ...
      <div class="text__wrap" v-if="langTitle || langSubTitle">
        <p class="title text__ellipsis commonTitle" v-if="langTitle">
          <span>
            {{ langTitle }}
          </span>
        </p>
        <p class="sub__title text__ellipsis commonSubTitle" v-if="langSubTitle">
          <span>
            {{ langSubTitle }}
          </span>
        </p>

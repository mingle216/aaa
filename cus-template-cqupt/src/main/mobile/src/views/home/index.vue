  ...
  <div class="container">
      ...
      <div class="head-title">
        <div class="top-content">
          <div class="left-title">
            <div :class="['name-div', 'homeTitle', { 'nosubtitlename': !langSubTitle }]" v-if="currentUser">
              HI~ {{ currentUser.userName }}
            </div>
            <div v-else  :class="['name-div', { 'nosubtitlename': !langSubTitle }]" @click="handleLogin">
              {{$Lan('CUS_TEMPLATE_CQUPT_h5', 'login', '请登录')}}
            </div>
            <div class="desc-div homeSubTitle" v-if="langSubTitle">
              {{ langSubTitle }}
            </div>
          </div>
      ...
      <!-- <div class="text__wrap">
        ...
        <div class="title-search">
          ...
          <we-button
            ...
            @click="handleSearch"
            >
              {{ $Lan('SYS_CARD_PERSONALDATA_h5', 'search', '搜索') }}
          </we-button>
        </div>
      </div> -->
    </div>
    ...
    <div class="head-title-top" v-show="isFixed">
      ...
      <div v-if="currentUser">
        ...
        ></i> -->
        <i
          :class="['iconfont', 'icon-menu-MyMessage', {'messageIconNew': totalNum > 0}]"
          v-if="messageUrl"
          @click="handleMessage"
        ></i>
...
export default {
  ...
  watch: {
    pageData: {
      handler(res) {
        ...
        //   JSON.parse(res.showProgrammeEntity.templateConfig || "")
        // ).isShowMsgCount;
  ...
  mounted() {
    ...
    // this.menusBar.forEach((item, index) => {
    ...
    //     );
    //     let num = (res && res.data !== "0" && res.data) || 0

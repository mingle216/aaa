...
export default {
  ...
  ".gateway-card .we-tabs__item": "{color: @portal-font-color-lv3 !important;}",
  ".we-tabs__item": "{color: @portal-font-color-lv2 !important;}",
  ".we-tabs__item.is-active": "{color: @portal-font-color-lv1 !important;}",
  ".expand .el-menu-item.is-active":
    "{color:#ffffff;background: linear-gradient(141.27deg, @portal-primary-color-lv2 -4.99%, @portal-primary-color-lv1 101.18%)!important;}",
  ".fold .el-menu-item.is-active": "{color:@portal-primary-color-lv1}",
  ".expand .el-menu-item:not(.is-active):hover .iconfont,.expand .el-menu-item:not(.is-active):hover":
    "{background:@portal-primary-color-lv5!important;color:@portal-primary-color-lv1}",
  ...
  ".templateTabs .we-tabs__nav-prev, .templateTabs .we-tabs__nav-next":
  ...
  ".we-date-table td.current:not(.disabled) span":
    "{background-color: @portal-primary-color-lv1}",
  ".home__header": "{background-color: @portal-primary-color-lv1!important;}",

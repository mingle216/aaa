<template>
  <div v-if="supportLanguages.length > 1 && currentUser">
    <we-dropdown @command="handleCommand" placement="bottom" trigger="click">
      <we-tooltip class="item" effect="dark" :content='$Lan("CUS_TEMPLATE_CQUPT", "language", "语言")' placement="bottom" :open-delay="100">
       <div class="c-box"> 

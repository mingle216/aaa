...
export default {
    computed: {
        ...
        headerImg() {
          return this.pageRenderData.pageConfig &&this.pageRenderData.pageConfig["header.imgUrl"] || "http://172.16.29.60:8116/sys_template_official/common/image/mobileHeader.png";
        },
        headerStyle() {
          ...
          const relUrl = isHttp
            ...
            : this.headerImg;
          return {
            background: `url(${relUrl}) no-repeat top center`,
            backgroundSize: '100%'
          };
        },
        // cardArea() {

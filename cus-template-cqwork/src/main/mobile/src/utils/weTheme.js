...
export default {
  ...
  ".we-tab": "{color:@portal-font-color-lv1;}",
  ...
  ".we-tab.we-tab--active": "{color:@portal-primary-color-lv1;}",
  ...
  ".we-tabbar-item--active .we-tabbar-item__icon": "{background-color: @portal-primary-color-lv1;}",

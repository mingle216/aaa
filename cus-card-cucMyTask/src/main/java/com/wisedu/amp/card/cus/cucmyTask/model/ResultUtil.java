...
public class ResultUtil {
    ...
    public enum CheckedFlag{
        //任务来源
        TASK_SOURCE("configure0", "0"),
        //当前流程节点
        CURRENT_FLOW_NODE("configure1", "1"),
        //当前待处理人
        ASSIGN_ID("configure2", "2"),
        //流程发起时间
        TASK_LAUNCH_TIME("configure3", "3");
        private String name;
        private String index;
    ...
    public enum RequestUrl{
        ...
        MY_TASK_LIST_URL("待办任务列表接口地址", "taskcenter_task_list_interface");
        private String name;
        private String index;

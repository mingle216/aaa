...
public class TaskInfoRequest {
    ...
    private String processClassifyType;

    public String getProcessClassifyType () {
        return processClassifyType;
    }

    public void setProcessClassifyType (String processClassifyType) {
        this.processClassifyType = processClassifyType;
    }

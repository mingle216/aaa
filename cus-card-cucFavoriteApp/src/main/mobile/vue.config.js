...
module.exports = {
  publicPath: devMode ? 'http://localhost:9004' : '/SYS_CARD_FAVORITEAPP/mobile',
  outputDir: '../resources/static/SYS_CARD_FAVORITEAPP/mobile',
  configureWebpack:{
    devtool: false,
    watch: false,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/SYS_CARD_FAVORITEAPP/mobile/',

package com.wisedu.amp.card.cus.serviceItemCategoryDetail.plugin;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.google.common.collect.Maps;
import com.wisedu.amp.card.cus.serviceItemCategoryDetail.model.*;
...
public class ServiceItemCategoryCardDetail extends AbstractCard {
    ...
    public String getCardId() {
        return "CUS_CARD_SERVICEITEMCATEGORYDETAIL";
    }
...
//            defaultColumn.add("duty_dept_id");
    ...
    private List<CheckBoxModel> getItemShowColumn(String lang) {
        ...
        ServiceItemCategoryResponse response = RestTemplateUtils
                .post("/coosk/itemManager/getItemShowColumn", entity, ServiceItemCategoryResponse.class)
                .getBody();
    ...
    private List<CheckBoxModel> getCategoryList() {
        ...
        HttpEntity entity = new HttpEntity(serviceitemcategoryrequest);
        ServiceItemCategoryResponse response = RestTemplateUtils
                .post("/coosk/itemManager/getOneCategoryList", entity, ServiceItemCategoryResponse.class)
                .getBody();
    ...
    private ServiceItemCategoryResponse allCateGoryList(CardAjaxRequest request) {
        ...
        HttpEntity entity = new HttpEntity(serviceitemcategoryrequest);
        ServiceItemCategoryResponse response = RestTemplateUtils
                .post("/coosk/itemManager/allCateGoryList", entity, ServiceItemCategoryResponse.class)
                .getBody();
...
//        }
    ...
    private RoleModel getRole(String roleWid, ConfigInfo config,String lang) {
        ...
        RoleModelResponse roleResponse = RestTemplateUtils.post("/coosk/itemManager/allRoleList", entity, RoleModelResponse.class).getBody();

<template>
  <div id="app" ref="appCon">
    <vue-scroll ref="vs" :barKeepShow="true" @vshandle-scroll="handleScroll" :scrollingX="true" :scrollCover="true" :nativeModel="true" @handle-scroll-complete="handleScrollComplete" >
    <component
...
export default {
  name: "App",
  components: { Home, Config, BackTop, ServiceItemModal,safariOpenServeDialog, SitesModal },
  data: () => ({
    // 展示卡片配置列表
    pageData: null,
    showBackTop: false,

<template>
  <div class="login__wrap">
      ...
      <we-dropdown-menu slot="dropdown">
        ...
        >
          ...
          <span class="text__ellipsis">
            {{ $Lan('CUS_TEMPLATE_LZJTU', 'personCenter', '个人中心') }}
          </span>
        </we-dropdown-item>
        <we-dropdown-item
        ...
        >
          ...
          <span class="text__ellipsis">
            {{ $Lan('CUS_TEMPLATE_LZJTU', 'positionManage', '岗位管理') }}
          </span>
        </we-dropdown-item>
        <we-dropdown-item
        ...
        >
          ...
          <span class="text__ellipsis">
            {{ $Lan('CUS_TEMPLATE_LZJTU', 'accountManage', '帐号管理') }}
          </span>
        </we-dropdown-item>
        <we-dropdown-item
        ...
        >
          ...
          <span class="text__ellipsis">
            {{ $Lan('CUS_TEMPLATE_LZJTU', 'backendManage', '后台管理') }}
          </span>
        </we-dropdown-item>
        <we-dropdown-item
          command="logout"
        ...
        >
          ...
          <span class="logout__item text__ellipsis">
            {{ $Lan('CUS_TEMPLATE_LZJTU', 'logout', '安全退出') }}
          </span>
        </we-dropdown-item>
      </we-dropdown-menu>
    </we-dropdown>
    <div
      ...
      @click="handleLogin"
    >
      {{ $Lan('CUS_TEMPLATE_LZJTU', 'login', '登录') }}
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleCommand(name) {
      const nameMap = {
        personCenterUrl: this.$Lan('CUS_TEMPLATE_LZJTU', 'personcenter', '个人中心'),
        postitionManagerUrl: this.$Lan('CUS_TEMPLATE_LZJTU', 'positionManage', '岗位管理'),
        accountManageUrl: this.$Lan('CUS_TEMPLATE_LZJTU', 'accountManage', '帐号管理'),
        changeSites: this.$Lan('CUS_TEMPLATE_LZJTU', 'changeSites', '切换站点'),
        backendManageUrl: this.$Lan('CUS_TEMPLATE_LZJTU', 'backManage', '后台管理'),
        logout: this.$Lan('CUS_TEMPLATE_LZJTU', 'logout', '注销')
      }

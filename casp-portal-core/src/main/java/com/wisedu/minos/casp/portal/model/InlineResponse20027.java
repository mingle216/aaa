...
public class InlineResponse20027 extends PaginationApiResponse  {
  @JsonProperty("data")
  @Valid
  private List<UserInfo> data = null;

  public InlineResponse20027 data(List<UserInfo> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20027 addDataItem(UserInfo dataItem) {
    if (this.data == null) {

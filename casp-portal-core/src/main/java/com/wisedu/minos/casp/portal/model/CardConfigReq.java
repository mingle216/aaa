...
public class CardConfigReq {
    ...
    public CardConfigReq(String cardId, String cardWid, String defaultConfig, ComponentContainer componentContainer, Integer platformType, String templateWid, String pageCode) {
        this.cardId = cardId;
        this.cardWid = cardWid;
        this.defaultConfig = defaultConfig;
        this.platformType = platformType;

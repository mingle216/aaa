...
//                }
                Object value = valueConfigJsonObj.get(abstractComponent.getKey());
                abstractComponent.setValueResult(ObjectUtils.isEmpty(value)? abstractComponent.getValue() : value);
            }

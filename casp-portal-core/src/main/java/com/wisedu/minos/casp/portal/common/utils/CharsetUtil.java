...
public final class CharsetUtil {
    ...
    public final static String toASCII (String str) throws UnsupportedEncodingException {
        return changeCharset(str, Global.US_ASCII);
    }
    ...
    public final static String toISO88591(String str) throws UnsupportedEncodingException {
        return changeCharset(str, Global.ISO_8859_1);
    }
    ...
    public static String toUTF8(String str) throws UnsupportedEncodingException {
        return changeCharset(str, Global.UTF_8);
    }
    ...
    public final static String toUTF16BE(String str) throws UnsupportedEncodingException {
        return changeCharset(str, Global.UTF_16BE);
    }
    ...
    public final static String toUTF16LE(String str) throws UnsupportedEncodingException {
        return changeCharset(str, Global.UTF_16LE);
    }
    ...
    public final static String toUTF16(String str) throws UnsupportedEncodingException {
        return changeCharset(str, Global.UTF_16);
    }
    ...
    public final static String toGBK (String str) throws UnsupportedEncodingException {
        return changeCharset(str, Global.GBK);
    }
    ...
    public final static String toGBKWithUTF8 (String input) throws UnsupportedEncodingException {
        if ( StringUtil.isEmpty(input) ) {
            ...
            String s1;
            s1 = new String(input.getBytes(Global.ISO_8859_1), Global.GBK);
            return s1;
        }
    }
    ...
    public final static String toUnicodeWithGBK (String input) throws UnsupportedEncodingException {
        if ( StringUtil.isEmpty(input) ) {
            ...
            String s1;
            s1 = new String(input.getBytes(Global.GBK), Global.ISO_8859_1);
            return s1;
        }
    }

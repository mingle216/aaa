...
public class RestTemplateUtils {
    ...
    // 传输的请求的IP地址
    private static final String REQ_SERVER_IP_HEAD = "console-server-ip";
    ...
    private RestTemplate gateWayRestTemplate() {
        ...
        bean.setInterceptors(Collections.singletonList((request, body, execution) -> {
            request.getHeaders().add(REQ_SERVER_IP_HEAD, WecIpUtil.getServeIp());
            // 服务或服务事项收藏/取消息收藏清除缓存
            ...
            if(url.contains("serviceFavorite/favoriteServiceItem") || url.contains("itemManager/favoriteItem")){
                ...
                keys.addAll(redisUtil.scan(allServiceItemKey));
...
//            }
    ...
    private HttpComponentsClientHttpRequestFactory clientHttpRequestFactory() {
        try {
            ...
            poolingHttpClientConnectionManager.setMaxTotal(1000); // 最大连接数100

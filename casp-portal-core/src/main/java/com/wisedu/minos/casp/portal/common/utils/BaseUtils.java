...
public class BaseUtils {
    ...
    /**
     * @Author jcx
     * @Description 将字符串转化为base64编码
     * @Date 10:48 2020/7/29
     * @Param s:
     * @return String
     **/
    public static String encode(String s) {
        try {
            ...
            logger.error("将字符串转化为base64编码发生异常",e);
            throw new BusinessException("将字符串转化为base64编码发生异常");
        }
    }
    ...
    public static String decode(String s)  {
        try {
            ...
            logger.error("BASE64 编码的字符串进行解码发生异常",e);
            throw new BusinessException("BASE64 编码的字符串进行解码发生异常");
        }
    }
    ...
    /**
     * @Author jcx
     * @Description 对输出流ByteArrayOutputStream编码
     * @Date 16:41 2020/8/5
     * @Param outputStream:
     * @return String
     **/

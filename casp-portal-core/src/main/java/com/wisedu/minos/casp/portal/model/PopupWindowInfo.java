...
public class PopupWindowInfo {
  ...
  public PopupWindowInfo wid(String wid) {
    this.wid = wid;
    return this;
  }
  ...
  **/
  ...
  public PopupWindowInfo popTitle(List<MultiLangData> popTitle) {
  ...
  public PopupWindowInfo pageWid(String pageWid) {
  ...
  public PopupWindowInfo popContents(List<MultiLangData> popContents) {
  ...
  public PopupWindowInfo begTime(LocalDateTime begTime) {
  ...
  public PopupWindowInfo endTime(LocalDateTime endTime) {
  ...
  public PopupWindowInfo popType(int popType) {
  ...
  public PopupWindowInfo isEnabled(int isEnabled) {
  ...
  public PopupWindowInfo titleLangKey(String titleLangKey) {
  ...
  public PopupWindowInfo contentsLangKey(String contentsLangKey) {
  ...
  public boolean equals(Object o) {
    ...
    PopupWindowInfo popupWindowReq = (PopupWindowInfo) o;

...
public class ProgrammeInfo   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(wid, programmeName, platformType, templateId, pageAmount, pageStatus, logoUrl, templateConfig, updateTime, createTime, sideFlag, isShowPcService);
  }

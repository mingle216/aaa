...
public class InlineResponse20019 extends ModelApiResponse  {
  @JsonProperty("data")
  @Valid
  private List<Object> data = null;

  public InlineResponse20019 data(List<Object> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20019 addDataItem(Object dataItem) {
    if (this.data == null) {

...
public class InlineResponse20012 extends ModelApiResponse  {
  @JsonProperty("data")
  @Valid
  private List<Object> data = null;

  public InlineResponse20012 data(List<Object> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20012 addDataItem(Object dataItem) {
    if (this.data == null) {

...
public class InlineResponse2009 extends ModelApiResponse  {
  @JsonProperty("data")
  @Valid
  private List<Object> data = null;

  public InlineResponse2009 data(List<Object> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2009 addDataItem(Object dataItem) {
    if (this.data == null) {

...
public class InlineResponse20021 extends ModelApiResponse  {
  @JsonProperty("data")
  @Valid
  private List<MenuBiz> data = null;

  public InlineResponse20021 data(List<MenuBiz> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20021 addDataItem(MenuBiz dataItem) {
    if (this.data == null) {

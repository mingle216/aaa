...
public class FileTypeUtil {
    ...
    /**
     * @Author jcx
     * @Description 根据File对象获取文件类型,包括图片,若格式不是已配置的,则返回null
     * @Date 15:11 2020/7/30
     * @Param file:
     * @return String
     **/
    ...
    /**
     * @Author jcx
     * @Description 根据文件流获取文件类型,包括图片,若格式不是已配置的,则返回null
     * @Date 15:11 2020/7/30
     * @Param b:
     * @return String
     **/

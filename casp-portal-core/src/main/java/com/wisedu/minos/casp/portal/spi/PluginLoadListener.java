...
import com.wisedu.minos.casp.portal.service.impl.AttachService;
import com.wisedu.minos.casp.portal.service.impl.ExecutorService;
import com.wisedu.minos.casp.portal.service.impl.PluginInstallService;
import com.wisedu.minos.casp.portal.service.impl.PluginService;
...
public class PluginLoadListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        logger.info("localIpAddress:{}", localIpAddress);
    ...
    private Map<String,Object> copyDownJar(OSSClientUtil ossClientUtil,AttachInfoEntity attachInfo,String jarName,
        ...
        caspSafetyService.legalPath(targetFileUrl+"/");

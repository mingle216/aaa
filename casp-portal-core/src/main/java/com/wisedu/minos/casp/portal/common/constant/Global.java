...
public class Global {
    ...
    // 门户相关license
    public static final String CASP_PC="casp-portal-pc";
    public static final String CASP_H5="casp-portal-h5";
    ...
    //门户检测登录登出，0：直接调用logout 1：跳转login
    public static final String CHECK_LOGIN_OR_LOGOUT="check_login_or_logout";
}

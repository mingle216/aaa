...
public class RadioComponent extends BasicComponent{
    ...
    private String explicitTips;

    public String getExplicitTips() {
        return explicitTips;
    }

    public void setExplicitTips(String explicitTips) {
        if( StringUtil.isEmpty(explicitTips) ){
            this.explicitTips ="value";
        }else{
            this.explicitTips = explicitTips;
        }
    }

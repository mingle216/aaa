...
public class QrCodeData implements Serializable {
     ...
     *          生成高度
     */
    public QrCodeData(String content, int imageWidth, int imageHeight) {
     ...
     *          内嵌图片的高度
     */
    public QrCodeData(InputStream innerImageStream, String content, int imageWidth, int imageHeight, int innerImageWidth, int innerImageHeight) {
     ...
     * @param argb
     */
    public QrCodeData(InputStream backImageStream, InputStream innerImageStream, String content, int imageWidth, int imageHeight, int outterImageWidth, int outterImageHeight, int frameWidth, int innerImageWidth, int innerImageHeight, int argb) {

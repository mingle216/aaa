...
public class ProgrammeBiz   {
  ...
  **/
  ...
  public ProgrammeBiz siteWid(String siteWid) {
  ...
  **/
  ...
  public ProgrammeBiz isPcServiceSupported(Integer isPcServiceSupported) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.wid, programmeBiz.wid) &&
        ...
        Objects.equals(this.siteWid, programmeBiz.siteWid) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(wid, programmeName, platformType, siteWid, templateId, templateCode, templateName, pageAmount, pageStatus, initializeFlag, isShowPcService, updateTime, createTime);
  }

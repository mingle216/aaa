...
public class UpdateStatusReq   {
  ...
  **/
  ...
  public UpdateStatusReq status(Integer status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(value = "启用停用0 停用 1启用")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.wid, updateStatusReq.wid) &&
        ...
        Objects.equals(this.status, updateStatusReq.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(wid, platformType, status);
  }

...
public class InlineResponse20016 extends ModelApiResponse  {
  @JsonProperty("data")
  @Valid
  private List<Object> data = null;

  public InlineResponse20016 data(List<Object> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20016 addDataItem(Object dataItem) {
    if (this.data == null) {

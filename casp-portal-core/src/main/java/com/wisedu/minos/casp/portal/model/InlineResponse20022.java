...
public class InlineResponse20022 extends ModelApiResponse  {
  @JsonProperty("data")
  private PageInfoRes data = null;

  public InlineResponse20022 data(PageInfoRes data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @ApiModelProperty(value = "")
    ...
    @Valid
    public PageInfoRes getData() {
    return data;
  }

  public void setData(PageInfoRes data) {
    this.data = data;
  }

...
import com.wisedu.minos.casp.portal.model.CardInfo;
...
public class InlineResponse2004 extends PaginationApiResponse  {
  @JsonProperty("data")
  @Valid
  private List<CardInfo> data = null;

  public InlineResponse2004 data(List<CardInfo> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2004 addDataItem(CardInfo dataItem) {
    if (this.data == null) {

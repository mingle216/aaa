      ...
      <header>
        <div class="header-top">
          <h3 class="portal-font-color-lv1">
            {{
              $Lan("CUS_CARD_OA_h5", "mySubscribe", "我的订阅")
            }}
          </h3>
      ...
      <main>
        <div class="main-top">
          <div class="top-left portal-font-color-lv2">
            <span class="text__ellipsis">{{
              $Lan("CUS_CARD_OA_h5", "checkedChannels", "已选")
            }}</span>
        ...
        <template v-if="list.length">
          <div class="addChannel portal-primary-color-lv1" @click="add">
            ...
            ><span class="text__ellipsis">{{
              $Lan("CUS_CARD_OA_h5", "addChannel", "订阅")
            }}</span>
          </div>
        ...
        <template v-else>
          <EmptyCon
            :tip="$Lan('CUS_CARD_OA_h5', 'noChannel', '暂无栏目')"
          ></EmptyCon>
          <we-button
          ...
          <div class="updateChannel-content">
            ...
            <footer>
              <we-button
                ...
                @click="submit"
                >{{
                  $Lan("CUS_CARD_OA_h5", "submit", "我选好了")
                }}</we-button
              >
            </footer>
          </div>

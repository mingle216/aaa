    ...
    <div class="subscribeModal__left">
      <div class="subscribeModal__header portal-font-color-lv2">
        <we-checkbox
          ...
          ><span
            ...
            >{{ $Lan("CUS_CARD_OA", "checkeAll", "全选") }}</span
          >
        ...
        <we-input
          v-model="keyword"
          :placeholder="
            $Lan('CUS_CARD_OA', 'placeholder', '请输入栏目名称')
          "
      ...
      >
        ...
        <EmptyCon
          ...
          :tip="$Lan('CUS_CARD_OA', 'noData', '暂无内容')"
      ...
      >
        ...
        >
          <span class="ellipsis" v-if="isScribeProgramme">
            {{ $Lan("CUS_CARD_OA", "checked", "已选") }}
          </span>
          <span class="ellipsis" v-else>
            {{ $Lan("CUS_CARD_OA", "checkedPrograms", "已选栏目") }}
          </span>

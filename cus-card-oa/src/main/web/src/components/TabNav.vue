<template>
  <div style="position: relative">
      ...
      >
        ...
        <span
          ...
          ><span
            ...
            >{{
              $Lan("CUS_CARD_OA", "subscribeBtn", "订阅")
            }}</span
          ></span
        >
      </div>
    ...
    <!-- 订阅modal -->
    <we-dialog
      :title="$Lan('CUS_CARD_OA', 'programLists', '栏目列表')"
      :append-to-body="true"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <we-button
          ...
          @click="handleClose"
          >{{ $Lan("CUS_CARD_OA", "cancel", "取 消") }}</we-button
        >
        <we-button
          type="primary"
          :class="[
          ...
          :disabled="disabled"
          @click="handleOk"
          >{{ $Lan("CUS_CARD_OA", "ok", "确 定") }}</we-button
        >
      </div>
    </we-dialog>
  </div>

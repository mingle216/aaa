...
module.exports = {
  publicPath: devMode ? 'http://localhost:5004' : '/CUS_CARD_NEWSANNOUNCEMENT/mobile',
  outputDir: '../resources/static/CUS_CARD_NEWSANNOUNCEMENT/mobile',
  configureWebpack:{
    devtool: false,
    watch: false,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/CUS_CARD_NEWSANNOUNCEMENT/mobile/',

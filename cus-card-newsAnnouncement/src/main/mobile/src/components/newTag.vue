<template>
  ...
  >
    ...
    <g
      id="链接导航/新闻通知公告/轮播图/消息中心/办理统计/个人数据/待办/办理进度/校历"
      stroke="none"
      stroke-width="1"
      fill="none"
      fill-rule="evenodd"
    >
      <g id="新闻通知公告" transform="translate(-1124.000000, -1934.000000)">
        <g id="编组-7" transform="translate(152.000000, 1761.000000)">
          <g id="04">
            <g
              id="新闻通知公告单列-仅标题时间备份"
              transform="translate(0.000000, 64.000000)"
            >
              <g id="编组-26" transform="translate(0.000000, 92.000000)">
                <g id="tag/最新" transform="translate(972.000000, 17.000000)">
                  <g
                    stroke-width="1"
                    fill-rule="evenodd"
                    fill="#FF9000"
                  ...
                  <g id="NEW" fill-rule="nonzero">
                    <use fill="#FFFFFF" xlink:href="#path-new"></use>
                    <use fill="#FF9000" xlink:href="#path-new"></use>
                  </g>
                </g>
              </g>
            </g>

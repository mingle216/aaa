 ...
 * @Date: 2023-07-26 13:17:12
 * @LastEditors: 杨芯悦 xyyang01@wisedu.com
 * @LastEditTime: 2023-07-26 13:19:53
 */
...
module.exports = {
  publicPath: devMode ? 'http://localhost:5011' : '/CUS_CARD_ROLESERVICEITEM/mobile',
  outputDir: '../resources/static/CUS_CARD_ROLESERVICEITEM/mobile',
  configureWebpack:{
    devtool: false,
    watch: false,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/CUS_CARD_ROLESERVICEITEM/mobile/',

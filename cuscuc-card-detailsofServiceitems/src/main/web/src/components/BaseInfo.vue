<template>
  ...
  <div class="basicInformation" style="position: relative">
    ...
    <ul class="dzgrxx">
      <li v-for="(item,index) in tableData" :key="index" :style="item.fieldName=='服务内容'? 'width:100%' : ''"><div><p class="portal-font-color-lv1">{{item.fieldName}}</p><p class="portal-font-color-lv1">{{item.fieldValue}}</p></div></li>
    </ul>
    <!-- <we-table

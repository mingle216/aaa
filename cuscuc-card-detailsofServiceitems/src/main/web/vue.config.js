...
module.exports = {
  publicPath: devMode ? 'http://localhost:5778' : '/CUSCUC_CARD_DETAILSOFSERVICEITEMS/pc',
  outputDir: '../resources/static/CUSCUC_CARD_DETAILSOFSERVICEITEMS/pc',
  configureWebpack: {
    devtool: false,
    watch: false,
    output: {
    ...
    plugins: [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/CUSCUC_CARD_DETAILSOFSERVICEITEMS/pc/',

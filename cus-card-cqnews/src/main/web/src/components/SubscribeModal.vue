    ...
    <div class="subscribeModal__left">
      <div class="subscribeModal__header portal-font-color-lv2">
        <we-checkbox
          ...
          ><span
            ...
            >{{ $Lan("CUS_CARD_CQNEWS", "checkeAll", "全选") }}</span
          >
        ...
        <we-input
          v-model="keyword"
          :placeholder="
            $Lan('CUS_CARD_CQNEWS', 'placeholder', '请输入栏目名称')
          "
      ...
      >
        ...
        <EmptyCon
          ...
          :tip="$Lan('CUS_CARD_CQNEWS', 'noData', '暂无内容')"
      ...
      >
        ...
        >
          <span class="ellipsis" v-if="isScribeProgramme">
            {{ $Lan("CUS_CARD_CQNEWS", "checked", "已选") }}
          </span>
          <span class="ellipsis" v-else>
            {{ $Lan("CUS_CARD_CQNEWS", "checkedPrograms", "已选栏目") }}
          </span>
        ...
        >
          ...
          ><span
            ...
            >{{ $Lan("CUS_CARD_CQNEWS", "reset", "重置") }}</span
          >
        </div>
      </div>

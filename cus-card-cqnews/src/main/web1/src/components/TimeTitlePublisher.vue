<template>
  <div class="publisher" :class="[lastRow ? '' : 'borderBootom']">
    ...
    >
      ...
      <div class="imgTitle__content ellipsis">
        {{ itemInfo.title && itemInfo.title.replace(/\n/g, " ") }}
      </div>
    </a>
    <div v-else class="publisher__list">
      <div class="publisher__list__info">
        <span class="cus-new" v-if="itemInfo.newDisplay"></span>
        <span class="cus-old" v-else></span>
        <a
          class="publisher__list__title ellipsis"

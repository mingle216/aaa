...
module.exports = {
  publicPath: devMode ? 'http://localhost:5001' : '/CUS_CARD_DETAILSOFSERVICEITEMS/pc',
  outputDir: '../resources/static/CUS_CARD_DETAILSOFSERVICEITEMS/pc',
  configureWebpack: {
    devtool: false,
    watch: false,
    output: {
    ...
    plugins: [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/CUS_CARD_DETAILSOFSERVICEITEMS/pc/',

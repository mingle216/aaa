...
export default {
  ...
  methods: {
    ...
    async submitEvaluate() {
      ...
      this.isValid = true;
      if (
        this.oSheetEvaluate.form.serviceManner === 0 ||
        this.oSheetEvaluate.form.serviceSpeed === 0 ||
        this.oSheetEvaluate.form.totalSatisfy === 0 ||
        this.oSheetEvaluate.form.eventIntegrity === 0
      ) {
        return;
      }
      this.$emit("submitEvaluate", this.oSheetEvaluate.form);
    },
  },
  watch: {
    appraiseName: {

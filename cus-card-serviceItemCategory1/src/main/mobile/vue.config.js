...
module.exports = {
  publicPath: devMode ? 'http://localhost:6004' : '/SYS_CARD_SERVICEITEMCATEGORY/mobile',
  outputDir: '../resources/static/SYS_CARD_SERVICEITEMCATEGORY/mobile',
  configureWebpack:{
    devtool: false,
    watch: false,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/SYS_CARD_SERVICEITEMCATEGORY/mobile/',

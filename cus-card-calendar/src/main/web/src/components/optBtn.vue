<template>
  <div class="optBtnWrap">
    ...
    >
      <we-tooltip
        effect="dark"
        :content="$Lan('SYS_CARD_CALENDAR', 'syncDingTalk', '同步钉钉数据')"
        placement="top"
        :open-delay="500"
      >
    ...
    >
      <we-tooltip
        effect="dark"
        :content="$Lan('SYS_CARD_CALENDAR', 'backToday', '回到今天')"
        placement="top"
        :open-delay="500"
      >
        <span
    ...
    >
      ...
      >
        <we-tooltip
          effect="dark"
          :content="$Lan('SYS_CARD_CALENDAR', 'subscribe', '订阅')"
          placement="top"
          :open-delay="500"
        >
          <span
    ...
    >
      ...
      >
        <we-tooltip
          effect="dark"
          :content="$Lan('SYS_CARD_CALENDAR', 'externalReference', '外部引用')"
          placement="top"
          :open-delay="500"
        >
          <LinkSvg style="width: 18px; height: 18px"></LinkSvg>
        </we-tooltip>
      </div>
    </we-popover>
    <!-- 查看更多 -->
    ...
    >
      <we-tooltip
        effect="dark"
        :content="$Lan('SYS_CARD_CALENDAR', 'showMore', '查看更多')"
        placement="top"
        :open-delay="500"
      >

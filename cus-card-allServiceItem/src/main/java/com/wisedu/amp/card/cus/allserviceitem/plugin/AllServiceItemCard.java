package com.wisedu.amp.card.cus.allserviceitem.plugin;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.wisedu.amp.card.cus.allserviceitem.enums.DisplayTypeEnum;
import com.wisedu.amp.card.cus.allserviceitem.enums.ItemDisplayInfoEnum;
import com.wisedu.amp.card.cus.allserviceitem.model.*;
import com.wisedu.amp.card.cus.allserviceitem.util.AllServiceItemUtil;
import com.wisedu.amp.card.cus.allserviceitem.util.ChinesePinyinUtil;
...
public class AllServiceItemCard extends AbstractCard {
    ...
    public String getCardId() {
        return "CUS_CARD_ALLSERVICEITEM";
    }

    @Override
    public void destroy() {
        logger.debug("card[CUS_CARD_ALLSERVICEITEM] destroyed ...");
    }
     ...
     * @param
     * @throws
     * @return java.util.List<com.wisedu.amp.card.cus.allserviceitem.enums.ItemDisplayInfoEnum>

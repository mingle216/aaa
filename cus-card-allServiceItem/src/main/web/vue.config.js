 ...
 * @Date: 2023-07-24 09:44:46
 * @LastEditors: 杨芯悦 xyyang01@wisedu.com
 * @LastEditTime: 2023-07-24 14:08:46
 */
...
module.exports = {
  publicPath: process.env.NODE_ENV === 'development' ? 'http://localhost:6100/' : '/CUS_CARD_ALLSERVICEITEM/pc',
  outputDir: '../resources/static/CUS_CARD_ALLSERVICEITEM/pc',
  configureWebpack: {

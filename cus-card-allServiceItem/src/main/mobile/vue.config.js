 ...
 * @Date: 2023-06-27 18:07:27
 * @LastEditors: 杨芯悦 xyyang01@wisedu.com
 * @LastEditTime: 2023-06-27 18:46:04
 */
...
module.exports = {
  publicPath: devMode ? 'http://localhost:5011' : '/CUS_CARD_ALLSERVICEITEM/mobile',
  outputDir: '../resources/static/CUS_CARD_ALLSERVICEITEM/mobile',
  configureWebpack:{
    devtool: false,
    watch: false,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/CUS_CARD_ALLSERVICEITEM/mobile/',

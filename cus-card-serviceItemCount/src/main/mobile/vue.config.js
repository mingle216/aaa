...
module.exports = {
  publicPath: devMode ? 'http://localhost:5008' : '/SYS_CARD_SERVICEITEMCOUNT/mobile',
  outputDir: '../resources/static/SYS_CARD_SERVICEITEMCOUNT/mobile',
  configureWebpack:{
    devtool: false,
    watch: true,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/SYS_CARD_SERVICEITEMCOUNT/mobile/',

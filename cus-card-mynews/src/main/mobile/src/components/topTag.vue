<template>
  <svg width="28px" height="14px" viewBox="0 0 28 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <g id="链接导航/新闻通知公告/轮播图/消息中心/办理统计/个人数据/待办/办理进度/校历" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          <g id="新闻通知公告" transform="translate(-1090.000000, -1934.000000)">
              <g id="编组-7" transform="translate(152.000000, 1761.000000)">
                  <g id="04">
                      <g id="新闻通知公告单列-仅标题时间备份" transform="translate(0.000000, 64.000000)">
                          <g id="编组-26" transform="translate(0.000000, 92.000000)">
                              <g id="tag/置顶" transform="translate(938.000000, 17.000000)">
                                  <g id="编组-3">

...
module.exports = {
  publicPath: devMode ? 'http://localhost:5009' : '/CUS_CARD_SEUMYFAVORITESX/mobile',
  outputDir: '../resources/static/CUS_CARD_SEUMYFAVORITESX/mobile',
  configureWebpack:{
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/CUS_CARD_SEUMYFAVORITESX/mobile/',

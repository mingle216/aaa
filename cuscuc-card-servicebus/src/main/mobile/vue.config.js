...
module.exports = {
  publicPath: devMode ? 'http://localhost:6003' : '/SYS_CARD_SERVICEBUS/mobile',
  outputDir: '../resources/static/SYS_CARD_SERVICEBUS/mobile',
  configureWebpack:{
    devtool: false,
    watch: true,
    output: {
    ...
    plugins:  [
      new SourceMapDevToolPlugin({ //修改soumap对应的文件路径
        filename: '[file].map',
        publicPath: '/SYS_CARD_SERVICEBUS/mobile/',
